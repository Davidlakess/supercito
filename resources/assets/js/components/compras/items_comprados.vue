<template>
  <b-row align-h="center">
    ...
    <b-col cols="10" style="margin-top: 15px; margin-bottom: 5%;">
          ...
          <div>
            ...
            <time-line :mobil="false" :status="status" v-if="status!=4"></time-line>
             ...
             <template v-if="status==4">
              ...
              <div class="divcancel" ><span class="cancel">Pedido Cancelado</span>
              <v-btn flat icon color="cyan"   @click.stop="dialog = true">
              <v-icon>info</v-icon>
              </v-btn>
              </div>
    <v-dialog
    ...
    >
      <v-card>
        <v-card-title class="headline">¿Por que mi pedido esta cancelado?</v-card-title>
        <v-card-text>
